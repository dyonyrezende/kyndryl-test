Requisitos para execução do projeto em servidor local:
...
Obs: Se não conseguir realizar o login no usuário criado ( a API as vezes não retornas dados do usuário 
criado para validação de login ), basta utilizar as informações de ID e Email de um dos usuários cadastrados na API (https://gorest.co.in/public/v2/users)
